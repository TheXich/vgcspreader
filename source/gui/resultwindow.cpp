...
QString ResultWindow::getCompleteString(const Turn& theTurn, const Pokemon& theDefendingPokemon, const bool isDualDefense, const float theRoll, const std::vector<float>& theDamagePerc) {
    ...
    defender_result = vs_string + getDefendPokemon(theDefendingPokemon, std::make_tuple(theDefendingPokemon.getEV(Stats::HP), theDefendingPokemon.getEV(Stats::DEF), theDefendingPokemon.getEV(Stats::SPDEF)), std::make_tuple((float)100, (int16_t)theDefendingPokemon.getModifier(Stats::DEF), (int16_t)theDefendingPokemon.getModifier(Stats::SPDEF), theDefendingPokemon.getTeraType(), theDefendingPokemon.isTerastallized(), false, false, false, false, false, false, false, false, false, false), theTurn.getMoves()[0].second, isDualDefense);
