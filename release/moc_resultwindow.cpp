/****************************************************************************
** Meta object code from reading C++ file 'resultwindow.hpp'
**
...
#include <memory>
#include "../include/gui/resultwindow.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'resultwindow.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 13), // "setResultType"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5) // "index"

    },
    "ResultWindow\0setResultType\0\0index"
};
...
void ResultWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setResultType((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
